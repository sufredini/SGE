...
namespace SGE.Controllers
{
    public class NotasController : Controller
    {
        ...
        {
            var contexto = _context.Notas.Include(n => n.Alunos).Include(n => n.Materias);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MateriasId,AlunosId,Nota")] Notas notas)
        {
            if (id != notas.Id)
            {
                return NotFound();
